package com.nguyentrongtri.ailatrieuphu4.dialog;
...
import com.nguyentrongtri.ailatrieuphu4.App;
import com.nguyentrongtri.ailatrieuphu4.R;
...
public class CallDialog extends Dialog implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.btn_help_02){
            getAnswer(1);
        } else
        if(v.getId()==R.id.btn_help_03){
            getAnswer(2);
        } else
        if(v.getId()==R.id.btn_help_04){
            getAnswer(3);
        } else
